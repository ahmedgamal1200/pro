...
{{--         </a>--}}
         <ul class="navbar-nav ml-auto d-flex align-items-center">
            ...
            <li class="nav-item">
               <a class="nav-link" href="{{url('/users')}}"><i class="feather-home mr-2"></i><span class="d-none d-lg-inline" style="color: #ff69b4;">Posts</span></a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="{{url('showApplications')}}"><i class="feather-briefcase mr-2"></i><span class="d-none d-lg-inline" style="color: #ff69b4;">Jobs</span></a>
            </li>
            <li class="nav-item">
{{--               <a class="nav-link" href="{{url('/users/myjobs')}}"><i class="feather-users mr-2"></i><span class="d-none d-lg-inline" style="color: #ff69b4;">My Jobs</span></a>--}}
            </li>
                                ...
                                <form action="{{ url('users/update-image/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="overflow-hidden text-center p-3">
                                            <button type="submit" name="action" value="update" class="font-weight-bold btn btn-light rounded p-3 d-block" style="color: #ff69b4;">
                                                Save
                                            </button>
                                        </div>
                                    </div>
                ...
                <main class="col-md-8">
                    <div class="border rounded bg-white mb-3">
                        <div class="box-title border-bottom p-3">
                            <h6 class="m-0" style="color: #ff69b4;">Edit Basic Info</h6>
                            <p class="mb-0 mt-0 small" style="color: #ff69b4;">{{old('name',$user->name)}}</p>
                        </div>
                        <div class="box-body p-3">
                            ...
                            <form class="js-validate" novalidate="novalidate" action="{{url('users/update-profile/'.$user->id)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-2" style="color: #ff69b4;">
                                ...
                                <label class="form-label" style="color: #ff69b4;">Birth date<span class="text-danger">*</span></label>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-2">
                                        <div class="js-form-message">
                                            <label id="phoneNumberLabel" class="form-label" style="color: #ff69b4;">Phone number<span class="text-danger">*</span></label>
                                            <div class="form-group">
                                ...
                                <div class="form-group mb-4" style="color: #ff69b4;">
                                    <label class="mb-1">About<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group mb-4" style="color: #ff69b4;">
                                    <label class="mb-1">EDUCATIONS<span class="text-danger">*</span></label>
                                    <div class="position-relative">
                                        <textarea class="form-control" rows="4" name="education"
                                    placeholder="Enter Your Education">{{ old('education', $user->profile?->education )}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group mb-4" style="color: #ff69b4;">
                                    <label class="mb-1">SKILLS<span class="text-danger">*</span></label>
                                    <div class="position-relative">
                                        <textarea class="form-control" rows="4" name="skill"
                                    placeholder="Enter Your Skills">{{ old('skill',$user->profile?->skill )}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group mb-4" style="color: #ff69b4;">
                                    <label class="mb-1">Places Worked For<span class="text-danger">*</span></label>
                                    <div class="position-relative">
                                        <textarea class="form-control" rows="4" name="location"
                                    placeholder="Enter Places Worked For">{{ old('location', $user->profile?->location )}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-2">
                                        <div class="js-form-message">
                                            <label id="passwordLabel" class="form-label" style="color: #ff69b4;">Password<span class="text-danger">*</span></label>
                                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="overflow-hidden text-center p-3">
                                    <button type="submit" value="update" class="font-weight-bold btn btn-light rounded p-3 d-block" style="color: #ff69b4;">
                                        Save
                                    </button>
                                    </div>
                                </div>
                                    ...
                                    <div class="user-info">
                                        <div class="box shadow-sm border rounded bg-white mb-3 osahan-post">
                                            ...
                                            <div class="p-3 border-bottom osahan-post-body">
                                                ...
                                                @endif
                                                <br/><br/>
                                                <a href="{{ url('users/edit-post/' . $post->id) }}" class="btn btn" style="background-color: #ff69b4; color: white;">Update Post</a>
                                                <a href="{{ url('users/edit-profile/delete-post/' . $post->id) }}" class="btn btn-dark">Delete Post</a>
                                            </div>

                                            <div class="p-3 osahan-comments-section" style="color: #ff69b4;">
