...
{{--            </li>--}}
            ...
            <li class="nav-item dropdown no-arrow ml-1 osahan-profile-dropdown">
              ...
              : 'data:image/png;base64,' }}"
                  ...
                  <a class="dropdown-item" href="{{url('profile')}}"><i class="feather-edit mr-1"></i> My Profile</a>
   ...
   <div class="py-4">
            ...
            <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
               ...
               <div class="box shadow-sm border rounded bg-white mb-3 osahan-share-post">
                  <ul class="nav nav-justified border-bottom osahan-line-tab" id="myTab" role="tablist">
                     <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" style="color: #ff69b4;"><i class="feather-edit" style="color: #ff69b4;"></i> Share an update</a>
    ...
    <textarea
        ...
        style="resize: none; padding: 0.5rem;">
                     ...
                     <div class="p-3 w-100">
                         <label for="photo" class="font-weight-bold" style="color: #ff69b4;">Upload a Photo:</label>
                        <div class="custom-file">
                         ...
                         <div class="border-top p-3 d-flex justify-content-end">
                             <button type="submit" class="btn d-flex align-items-center" style="background-color: #ff69b4; color: white; border: none;">
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
               <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                  ...
                  <div class="overflow-hidden border-top">
                     <a class="font-weight-bold p-3 d-block" style="color: #ff69b4;" href="{{ url('profile') }}"> View my profile </a>
                  </div>
               </div>
            </aside>
